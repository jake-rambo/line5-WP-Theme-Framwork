<?php get_header(); ?>
	...
	<main role="main">
		...
		<?php if (have_posts()): the_post(); ?>
			...
			<h1><?php _e( 'Author Archives for ', 'line5_theme' ); echo get_the_author(); ?></h1>

		<?php if ( get_the_author_meta('description')) : ?>

		<?php echo get_avatar(get_the_author_meta('user_email')); ?>

			<h2><?php _e( 'About ', 'line5_theme' ); echo get_the_author() ; ?></h2>
		...
		<?php rewind_posts(); while (have_posts()) : the_post(); ?>
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<?php line5_wp_excerpt('line5_wp_index'); // Build your custom callback length in functions.php ?>
